...
public enum  TencentAPI {
    ...
    VKEY("https://u.y.qq.com/cgi-bin/musicu.fcg?g_tk=5381&format=json&inCharset=utf8&outCharset=utf-8&data={data}",HttpMethod.GET),
    ...
    USER_HEAD_IMG("https://u.y.qq.com/cgi-bin/musicu.fcg?loginUin=1719982754&inCharset=utf8&outCharset=GB2312&data={data}",HttpMethod.GET),
    ...
    SONG_SIZE("https://c.y.qq.com/qqmusic/fcgi-bin/qm_rplstingmus.fcg?version=17&miniversion=24&musicid=%s",HttpMethod.GET),
